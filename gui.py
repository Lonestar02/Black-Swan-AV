...
ENGINE_PATH = "/home/moon/antivirusProject/engine"   # Engine path
ENGINE_RTM_PATH = "/home/moon/antivirusProject/realtime_monitor"  # RTM
...
# Home page
my_label = Label(root, text="BLACK SWAN AV", font=("Helvetica", 60, "bold"), bg="#262626", fg="white")
